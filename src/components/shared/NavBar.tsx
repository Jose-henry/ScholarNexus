              ...
              <div className="flex flex-col gap-[30px]">
                ...
                <div className=" gap-[30px] flex flex-col items-center justify-center">
                  {sidebarLinks.map((link) => {
                    ...
                    return (
                      <Link href={link.route} key={link.label} className={`relative flex justify-start gap-2 rounded-sm ${isActive && 'bg-[#9ba6a5] rounded-sm p-[4px]' } hover:bg-[#4b4a4c] hover:rounded-sm hover:transition-all hover:p-[4px]`} >
                        ...
                        <div className="flex cursor-pointer gap-4 p-[4px] hover:bg-[#4b4a4c] hover:rounded-sm hover:transition-all">
